        ...
        try {
            ...
            // com/dyuproject/protostuff/parser/ProtoParser.g:103:9: k= var_full ASSIGN (vr= var_reserved | ID | fid= FULL_ID | NUMFLOAT | NUMINT | NUMDOUBLE | TRUE | FALSE | STRING_LITERAL )
            {
                ...
                switch (alt7) {
                    ...
                    {
                        STRING_LITERAL31 = (Token) match(input, STRING_LITERAL, FOLLOW_STRING_LITERAL_in_annotation_keyval821);
                        if (state.failed) return retval;
                        if (state.backtracking == 0) {
        ...
        try {
            ...
            // com/dyuproject/protostuff/parser/ProtoParser.g:153:9: OPTION ( LEFTPAREN )? k= var_full ( RIGHTPAREN )? ASSIGN (vr= var_reserved | id= ID | fid= FULL_ID | NUMFLOAT | NUMINT | NUMDOUBLE | TRUE | FALSE | STRING_LITERAL ) SEMICOLON
            {
                ...
                switch (alt11) {
                    ...
                    {
                        STRING_LITERAL52 = (Token) match(input, STRING_LITERAL, FOLLOW_STRING_LITERAL_in_option_entry1157);
                        if (state.failed) return retval;
                        if (state.backtracking == 0) {
        ...
        try {
            ...
            // com/dyuproject/protostuff/parser/ProtoParser.g:272:9: key= var_full ASSIGN (vr= var_reserved | STRING_LITERAL | NUMFLOAT | NUMINT | NUMDOUBLE | HEX | OCTAL | TRUE | FALSE | val= ID | FULL_ID | EXP | signed_constant[proto, message, field, $key.text, checkDefault] )
            {
                ...
                switch (alt21) {
                    ...
                    {
                        STRING_LITERAL105 = (Token) match(input, STRING_LITERAL, FOLLOW_STRING_LITERAL_in_field_options_keyval1865);
                        if (state.failed) return retval;
                        if (state.backtracking == 0) {
