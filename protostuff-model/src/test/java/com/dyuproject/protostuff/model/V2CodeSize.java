...
public final class V2CodeSize {
  ...
  public static final class Person extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.dyuproject.protostuff.model.V2CodeSize.internal_static_testmodel_Person_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.dyuproject.protostuff.model.V2CodeSize.internal_static_testmodel_Person_fieldAccessorTable;
    }
    ...
    private java.util.List<com.dyuproject.protostuff.model.V2CodeSize.Task> DelegatedTask_ =
      java.util.Collections.emptyList();
    public java.util.List<com.dyuproject.protostuff.model.V2CodeSize.Task> getDelegatedTaskList() {
      return DelegatedTask_;
    }
    public int getDelegatedTaskCount() { return DelegatedTask_.size(); }
    public com.dyuproject.protostuff.model.V2CodeSize.Task getDelegatedTask(int index) {
    ...
    private java.util.List<com.dyuproject.protostuff.model.V2CodeSize.Task> PriorityTask_ =
      java.util.Collections.emptyList();
    public java.util.List<com.dyuproject.protostuff.model.V2CodeSize.Task> getPriorityTaskList() {
      return PriorityTask_;
    }
    public int getPriorityTaskCount() { return PriorityTask_.size(); }
    public com.dyuproject.protostuff.model.V2CodeSize.Task getPriorityTask(int index) {
    ...
    private com.dyuproject.protostuff.model.V2CodeSize.Task currentTask_;
    public boolean hasCurrentTask() { return hasCurrentTask; }
    public com.dyuproject.protostuff.model.V2CodeSize.Task getCurrentTask() { return currentTask_; }
    ...
    private void initFields() {
      currentTask_ = com.dyuproject.protostuff.model.V2CodeSize.Task.getDefaultInstance();
    }
    public static com.dyuproject.protostuff.model.V2CodeSize.Person parseFrom(
    ...
    public static com.dyuproject.protostuff.model.V2CodeSize.Person parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.dyuproject.protostuff.model.V2CodeSize.Person parseFrom(
    ...
    public static com.dyuproject.protostuff.model.V2CodeSize.Person parseFrom(java.io.InputStream input)
    ...
    public static com.dyuproject.protostuff.model.V2CodeSize.Person parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.dyuproject.protostuff.model.V2CodeSize.Person parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(com.dyuproject.protostuff.model.V2CodeSize.Person prototype) {
    ...
    public static final class Builder extends
      ...
      private com.dyuproject.protostuff.model.V2CodeSize.Person result;
      
      // Construct using com.dyuproject.protostuff.model.V2CodeSize.Person.newBuilder()
      private Builder() {}
      
      private static Builder create() {
        Builder builder = new Builder();
        builder.result = new com.dyuproject.protostuff.model.V2CodeSize.Person();
        return builder;
      }
      
      protected com.dyuproject.protostuff.model.V2CodeSize.Person internalGetResult() {
        return result;
      }
      ...
      public Builder clear() {
        ...
        result = new com.dyuproject.protostuff.model.V2CodeSize.Person();
        return this;
      }
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return com.dyuproject.protostuff.model.V2CodeSize.Person.getDescriptor();
      }
      
      public com.dyuproject.protostuff.model.V2CodeSize.Person getDefaultInstanceForType() {
        return com.dyuproject.protostuff.model.V2CodeSize.Person.getDefaultInstance();
      }
      
      public boolean isInitialized() {
        return result.isInitialized();
      }
      public com.dyuproject.protostuff.model.V2CodeSize.Person build() {
      ...
      private com.dyuproject.protostuff.model.V2CodeSize.Person buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        if (!isInitialized()) {
      ...
      public com.dyuproject.protostuff.model.V2CodeSize.Person buildPartial() {
        if (result == null) {
          throw new IllegalStateException(
        ...
        com.dyuproject.protostuff.model.V2CodeSize.Person returnMe = result;
        result = null;
        return returnMe;
      }
  ...
  result.hasLastName = true;
      ...
      public Builder setDelegatedTask(int index, com.dyuproject.protostuff.model.V2CodeSize.Task value) {
        if (value == null) {
          throw new NullPointerException();
        }
      ...
      public Builder setDelegatedTask(int index, com.dyuproject.protostuff.model.V2CodeSize.Task.Builder builderForValue) {
        result.DelegatedTask_.set(index, builderForValue.build());
        return this;
      }
      public Builder addDelegatedTask(com.dyuproject.protostuff.model.V2CodeSize.Task value) {
        if (value == null) {
          throw new NullPointerException();
        }
        if (result.DelegatedTask_.isEmpty()) {
          result.DelegatedTask_ = new java.util.ArrayList<com.dyuproject.protostuff.model.V2CodeSize.Task>();
        }
        result.DelegatedTask_.add(value);
        return this;
      }
      public Builder addDelegatedTask(com.dyuproject.protostuff.model.V2CodeSize.Task.Builder builderForValue) {
        if (result.DelegatedTask_.isEmpty()) {
          result.DelegatedTask_ = new java.util.ArrayList<com.dyuproject.protostuff.model.V2CodeSize.Task>();
        }
      ...
      public Builder addAllDelegatedTask(
          java.lang.Iterable<? extends com.dyuproject.protostuff.model.V2CodeSize.Task> values) {
        if (result.DelegatedTask_.isEmpty()) {
          result.DelegatedTask_ = new java.util.ArrayList<com.dyuproject.protostuff.model.V2CodeSize.Task>();
        }
      ...
      public Builder setPriorityTask(int index, com.dyuproject.protostuff.model.V2CodeSize.Task value) {
        if (value == null) {
          throw new NullPointerException();
        }
      ...
      public Builder setPriorityTask(int index, com.dyuproject.protostuff.model.V2CodeSize.Task.Builder builderForValue) {
        result.PriorityTask_.set(index, builderForValue.build());
        return this;
      }
      public Builder addPriorityTask(com.dyuproject.protostuff.model.V2CodeSize.Task value) {
        if (value == null) {
          throw new NullPointerException();
        }
        if (result.PriorityTask_.isEmpty()) {
          result.PriorityTask_ = new java.util.ArrayList<com.dyuproject.protostuff.model.V2CodeSize.Task>();
        }
        result.PriorityTask_.add(value);
        return this;
      }
      public Builder addPriorityTask(com.dyuproject.protostuff.model.V2CodeSize.Task.Builder builderForValue) {
        if (result.PriorityTask_.isEmpty()) {
          result.PriorityTask_ = new java.util.ArrayList<com.dyuproject.protostuff.model.V2CodeSize.Task>();
        }
      ...
      public com.dyuproject.protostuff.model.V2CodeSize.Task getCurrentTask() {
        return result.getCurrentTask();
      }
      public Builder setCurrentTask(com.dyuproject.protostuff.model.V2CodeSize.Task value) {
        if (value == null) {
          throw new NullPointerException();
        }
      ...
      public Builder setCurrentTask(com.dyuproject.protostuff.model.V2CodeSize.Task.Builder builderForValue) {
        result.hasCurrentTask = true;
        result.currentTask_ = builderForValue.build();
        return this;
      }
      public Builder mergeCurrentTask(com.dyuproject.protostuff.model.V2CodeSize.Task value) {
        if (result.hasCurrentTask() &&
            result.currentTask_ != com.dyuproject.protostuff.model.V2CodeSize.Task.getDefaultInstance()) {
          result.currentTask_ =
            com.dyuproject.protostuff.model.V2CodeSize.Task.newBuilder(result.currentTask_).mergeFrom(value).buildPartial();
        } else {
          result.currentTask_ = value;
        }
        result.hasCurrentTask = true;
  ...
  if (result.image_.isEmpty()) {
    ...
    static {
      ...
      com.dyuproject.protostuff.model.V2CodeSize.internalForceInit();
  ...
  public static final class Task extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.dyuproject.protostuff.model.V2CodeSize.internal_static_testmodel_Task_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.dyuproject.protostuff.model.V2CodeSize.internal_static_testmodel_Task_fieldAccessorTable;
    }
    ...
    public enum Status
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return com.dyuproject.protostuff.model.V2CodeSize.Task.getDescriptor().getEnumTypes().get(0);
      }
      ...
      static {
        com.dyuproject.protostuff.model.V2CodeSize.getDescriptor();
      }
    ...
    private com.dyuproject.protostuff.model.V2CodeSize.Task.Status status_;
    public boolean hasStatus() { return hasStatus; }
    public com.dyuproject.protostuff.model.V2CodeSize.Task.Status getStatus() { return status_; }
    ...
    private void initFields() {
      status_ = com.dyuproject.protostuff.model.V2CodeSize.Task.Status.PENDING;
    }
    public static com.dyuproject.protostuff.model.V2CodeSize.Task parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    ...
    public static com.dyuproject.protostuff.model.V2CodeSize.Task parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.dyuproject.protostuff.model.V2CodeSize.Task parseFrom(
    ...
    public static com.dyuproject.protostuff.model.V2CodeSize.Task parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeFrom(input).buildParsed();
    }
    public static com.dyuproject.protostuff.model.V2CodeSize.Task parseFrom(
    ...
    public static com.dyuproject.protostuff.model.V2CodeSize.Task parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      Builder builder = newBuilder();
      if (builder.mergeDelimitedFrom(input)) {
        return builder.buildParsed();
    ...
    public static com.dyuproject.protostuff.model.V2CodeSize.Task parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(com.dyuproject.protostuff.model.V2CodeSize.Task prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessage.Builder<Builder> {
      private com.dyuproject.protostuff.model.V2CodeSize.Task result;
      
      // Construct using com.dyuproject.protostuff.model.V2CodeSize.Task.newBuilder()
      private Builder() {}
      
      private static Builder create() {
        Builder builder = new Builder();
        builder.result = new com.dyuproject.protostuff.model.V2CodeSize.Task();
        return builder;
      }
      
      protected com.dyuproject.protostuff.model.V2CodeSize.Task internalGetResult() {
        return result;
      }
      ...
      public Builder clear() {
        ...
        result = new com.dyuproject.protostuff.model.V2CodeSize.Task();
        return this;
      }
      ...
      public com.google.protobuf.Descriptors.Descriptor
          getDescriptorForType() {
        return com.dyuproject.protostuff.model.V2CodeSize.Task.getDescriptor();
      }
      
      public com.dyuproject.protostuff.model.V2CodeSize.Task getDefaultInstanceForType() {
        return com.dyuproject.protostuff.model.V2CodeSize.Task.getDefaultInstance();
      }
      
      public boolean isInitialized() {
        return result.isInitialized();
      }
      public com.dyuproject.protostuff.model.V2CodeSize.Task build() {
        if (result != null && !isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return buildPartial();
      ...
      private com.dyuproject.protostuff.model.V2CodeSize.Task buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        if (!isInitialized()) {
          throw newUninitializedMessageException(
            result).asInvalidProtocolBufferException();
      ...
      public com.dyuproject.protostuff.model.V2CodeSize.Task buildPartial() {
        if (result == null) {
          throw new IllegalStateException(
            "build() has already been called on this Builder.");
        }
        com.dyuproject.protostuff.model.V2CodeSize.Task returnMe = result;
        result = null;
        return returnMe;
      }
  ...
  result.hasDescription = true;
      ...
      public com.dyuproject.protostuff.model.V2CodeSize.Task.Status getStatus() {
        return result.getStatus();
      }
      public Builder setStatus(com.dyuproject.protostuff.model.V2CodeSize.Task.Status value) {
        if (value == null) {
          throw new NullPointerException();
        }
      ...
      public Builder clearStatus() {
        ...
        result.status_ = com.dyuproject.protostuff.model.V2CodeSize.Task.Status.PENDING;
        return this;
      }
        ...
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_testmodel_Person_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              ...
              com.dyuproject.protostuff.model.V2CodeSize.Person.class,
              com.dyuproject.protostuff.model.V2CodeSize.Person.Builder.class);
          internal_static_testmodel_Task_descriptor =
          ...
          internal_static_testmodel_Task_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              ...
              com.dyuproject.protostuff.model.V2CodeSize.Task.class,
              com.dyuproject.protostuff.model.V2CodeSize.Task.Builder.class);
          return null;
        }
      };
