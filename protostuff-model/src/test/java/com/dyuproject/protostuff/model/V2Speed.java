...
public final class V2Speed {
  ...
  public static final class Person extends
    ...
    private java.util.List<com.dyuproject.protostuff.model.V2Speed.Task> DelegatedTask_ =
    ...
    private java.util.List<com.dyuproject.protostuff.model.V2Speed.Task> PriorityTask_ =
      java.util.Collections.emptyList();
    ...
    public com.dyuproject.protostuff.model.V2Speed.Task getCurrentTask() { return currentTask_; }
    ...
    public static com.dyuproject.protostuff.model.V2Speed.Person parseFrom(
    ...
    public static com.dyuproject.protostuff.model.V2Speed.Person parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.dyuproject.protostuff.model.V2Speed.Person parseFrom(
    ...
    public static com.dyuproject.protostuff.model.V2Speed.Person parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.dyuproject.protostuff.model.V2Speed.Person parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.dyuproject.protostuff.model.V2Speed.Person parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static final class Builder extends
      ...
      // Construct using com.dyuproject.protostuff.model.V2Speed.Person.newBuilder()
      private Builder() {}
      ...
      private com.dyuproject.protostuff.model.V2Speed.Person buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        if (!isInitialized()) {
  ...
  result.hasLastName = true;
      ...
      public Builder addAllDelegatedTask(
          java.lang.Iterable<? extends com.dyuproject.protostuff.model.V2Speed.Task> values) {
        if (result.DelegatedTask_.isEmpty()) {
          result.DelegatedTask_ = new java.util.ArrayList<com.dyuproject.protostuff.model.V2Speed.Task>();
        }
      ...
      public Builder mergeCurrentTask(com.dyuproject.protostuff.model.V2Speed.Task value) {
        if (result.hasCurrentTask() &&
          ...
          result.currentTask_ =
            com.dyuproject.protostuff.model.V2Speed.Task.newBuilder(result.currentTask_).mergeFrom(value).buildPartial();
        } else {
          result.currentTask_ = value;
        }
        result.hasCurrentTask = true;
  ...
  public static final class Task extends
    ...
    public com.dyuproject.protostuff.model.V2Speed.Task.Status getStatus() { return status_; }
    ...
    public static com.dyuproject.protostuff.model.V2Speed.Task parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    ...
    public static com.dyuproject.protostuff.model.V2Speed.Task parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.dyuproject.protostuff.model.V2Speed.Task parseFrom(
    ...
    public static com.dyuproject.protostuff.model.V2Speed.Task parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeFrom(input).buildParsed();
    }
    public static com.dyuproject.protostuff.model.V2Speed.Task parseFrom(
    ...
    public static com.dyuproject.protostuff.model.V2Speed.Task parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      Builder builder = newBuilder();
      if (builder.mergeDelimitedFrom(input)) {
        return builder.buildParsed();
    ...
    public static com.dyuproject.protostuff.model.V2Speed.Task parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static final class Builder extends
      ...
      // Construct using com.dyuproject.protostuff.model.V2Speed.Task.newBuilder()
      private Builder() {}
      ...
      private com.dyuproject.protostuff.model.V2Speed.Task buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        if (!isInitialized()) {
          throw newUninitializedMessageException(
            result).asInvalidProtocolBufferException();
        ...
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_testmodel_Person_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              ...
              com.dyuproject.protostuff.model.V2Speed.Person.class,
              com.dyuproject.protostuff.model.V2Speed.Person.Builder.class);
          internal_static_testmodel_Task_descriptor =
          ...
          internal_static_testmodel_Task_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              ...
              com.dyuproject.protostuff.model.V2Speed.Task.class,
              com.dyuproject.protostuff.model.V2Speed.Task.Builder.class);
          return null;
        }
      };
