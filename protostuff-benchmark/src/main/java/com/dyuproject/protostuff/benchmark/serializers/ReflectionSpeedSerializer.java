...
public class ReflectionSpeedSerializer extends AbstractSpeedMediaSerializer
{
    
    final ReflectionJSON pbJSON = new ReflectionJSON(new Class[]{V22SpeedMedia.class});
