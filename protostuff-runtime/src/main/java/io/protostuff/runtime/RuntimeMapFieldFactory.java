...
final class RuntimeMapFieldFactory
{
            ...
            final Pipe.Schema<Object> valuePipeSchema, final IdStrategy strategy)
    {
                ...
                number, name, f.getAnnotation(Tag.class), messageFactory)
        {
            ...
            protected Field<T> copy(IdStrategy strategy)
            {
                return createMapEnumKObjectV(number, name, f, messageFactory, clazzK, valueSchema, valuePipeSchema, strategy);
            }
        };
    }
            ...
            final Pipe.Schema<Object> valuePipeSchema, final IdStrategy strategy)
    {
                ...
                number, name, f.getAnnotation(Tag.class), messageFactory)
        {
            ...
            protected Field<T> copy(IdStrategy strategy)
            {
                return createMapPojoKObjectV(number, name, f, messageFactory, clazzK, valueSchema, valuePipeSchema, strategy);
            }
        };
    }
